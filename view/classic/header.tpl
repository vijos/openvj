...
<a id="StranLink" href="#">正体</a><script type="text/javascript" src="static/Std_StranJF.js"></script>&emsp;|&emsp;{{ IF $user }}<a href="user/logout?sid={{ q($global_sid) }}">登出</a>
{{ ELSE }}
...
<div id="cnews">
<div class="section"><div class="s_c s_lt"></div><div class="s_c s_rt"></div><div class="s_c s_lb"></div><div class="s_c s_rb"></div><div class="s_v s_t"></div><div class="s_v s_b"></div><div class="s_v s_l"></div><div class="s_v s_r"></div><div class="s_content">
<marquee id="news" direction="left" scrollamount="4" onMouseOver="this.stop();" onMouseOut="this.start();">
